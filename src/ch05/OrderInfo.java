...
// 그 외, kebab-case(order-info, 주소url, 사이트명칭, 컴포넌트이름..., 소문자 단어사이에 -)
// snake-case(order_info, 데이터베이스시스템, 단어사이에 underscore를 씀, 단어는 주로 소문자이나, 대문자만으로 하는 경우도 있음)
// ORDER_INFO
public class OrderInfo {
    ...
    private double totalPrice; // 구매합계
    ...
    // 객체(object, instance)는 클래스로 찍어낸 것을 객체
