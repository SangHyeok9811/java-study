...
public class AccountManagement {
    ...
    public AccountManagement() {
        accounts = new HashMap<>(); // 계좌목록 리스트 생성
    ...
    public void addAccount(String accountNumber, double balance) {
        ...
        accounts.put(accountNumber, account);    // 계좌 추가
        System.out.println("계좌가 추가되었습니다.");
        System.out.println("추가된 계좌는: " + "\"" + accountNumber + "\" 입니다" );           // 추가된 계좌 확인
        numAccounts++;
    }
...
//        for (int i = 0; i < numAccounts; i++) {
//            if (accounts[1].getAccountNumber().equals(accounts)) {
//                return accounts[i];
//            }
//            return null;
//    }
